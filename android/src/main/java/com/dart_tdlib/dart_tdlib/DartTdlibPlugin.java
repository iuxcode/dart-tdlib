package com.dart_tdlib.dart_tdlib;
...
// todo: no context
/** DartTdlibPlugin */
public class DartTdlibPlugin implements MethodCallHandler, FlutterPlugin {
  private static final String TDLIB_CHANNEL_NAME = "dart_tdlib";
  private static final String TDLIB_RECEIVE_CHANNEL_NAME = "dart_tdlib/receive";
