...
class TdClient {
  ...
  static const EventChannel _eventChannel = EventChannel('channel/to/tdlib/receive');
  ...
  static Future<void> destroyClient(int clientId) async => await _platform.invokeMethod(
    'clientDestroy', 
    <String, dynamic>{ 'client': clientId }
  );

  /// Sends request to the TDLib client. May be called from any thread.
  static Future<void> clientSend(int clientId, TdFunction event) async => await _platform.invokeMethod(
    'clientSend',
  ...
  static Stream<TdObject?> clientEvents(int clientId) {
    return _eventChannel.receiveBroadcastStream(clientId).map((event) {
  ...
  static Future<TdObject> clientReceive(int clientId, double timeout) async => convertToObject(await _platform.invokeMethod('clientReceive',<String, dynamic>{'client': clientId, 'timeout': timeout}))!;
  ...
  static Future<TdObject> clientExecute(int clientId, TdFunction event) async => convertToObject(await _platform.invokeMethod('clientExecute',<String, dynamic>{'client': clientId, 'query': json.encode(event)}))!;
